...
find_path(LAPACK_INCLUDE_DIR
	NAMES "clapack.h"
	HINTS "${LAPACK_DIR}"
    PATHS "$ENV{PROGRAMFILES}/clapack" "$ENV{PROGRAMW6432}/clapack" "/usr" "/usr/local"
	PATH_SUFFIXES "include" "include/clapack")
...
if(EXISTS "${LAPACK_INCLUDE_DIR}" AND NOT "${LAPACK_INCLUDE_DIR}" STREQUAL "")
	...
	foreach(LIBCOMP ${LAPACK_LIB_COMPONENTS})
		...
		find_library(LAPACK_${LIBCOMP}_LIBRARY_ALL NAMES "${LIBCOMP}" PATH_SUFFIXES "clapack")
		...
		#both debug/release
		elseif(LAPACK_${LIBCOMP}_LIBRARY_ALL)
			set(LAPACK_${LIBCOMP}_LIBRARY ${LAPACK_${LIBCOMP}_LIBRARY_ALL} CACHE STRING "" FORCE)
		#no library found
		else()
